...
class AccountInterface(AbstractInterface):
    # Dont override this. Use "initialise()" to init a children interface
    def __init__(self, config: Configuration) -> None:
    ...
    @abstractmethod
    def get_market_info(self, market_ticket: str) -> Market:
        pass
...
class StocksInterface(AbstractInterface):
    # This Must not be overwritten. Use again "initialise()" to init a children interface
